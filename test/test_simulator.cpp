...
TEST_CASE("Constructor - (Simulator)")
{
  ...
  CHECK_NOTHROW(Simulator("../networks/NSFNet.json", "../networks/NSFNet_routes.json"));
  CHECK_NOTHROW(Simulator("../networks/NSFNet.json", "../networks/NSFNet_routes.json", "../bitrate/bitrate.json"));
}
